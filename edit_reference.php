...
if (isset($_POST['submit']))
 {
	 ...
	 $order=trim($_POST['order']);
	  ...
	  $query="UPDATE `references` SET `ref_name` = '$ref_name' , `ref_score` = '$ref_score', `ref_from_age` = '$ref_from_age', `ref_to_age` = '$ref_to_age',`categoryid`='$category', `ref_gender` = '$ref_gender', `order` = '$order' WHERE `id` = $refid;";
	  mysqli_query($con,$query) or die(mysqli_error($con));
	  echo"<script>alert('Reference Update successfully'); window.location='reference.php';</script>";

 }
 $query="SELECT * FROM `references` WHERE `id`=".trim($_GET['id']);;
	  				...
	  				<div class="col-md-12">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">Edit Reference</div>
			  				...
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
                                    <input type="hidden" class="form-control"  name="refid" required  value="<?php echo $data['id']; ?>"> 
								      <input type="text" class="form-control" id="inputcategory" name="ref_name" required placeholder="Raw score" value="<?php echo $data['ref_name']; ?>" >
								    </div>
								  </div>
                                  <div class="form-group">
								    <label for="inputorder" class="col-sm-2 control-label">certile</label>
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="inputorder" required name="ref_score"  value="<?php echo $data['ref_score']; ?>" >
								    </div>
								  </div> 
                                   <div class="form-group">
								    ...
								    <div class="col-sm-10">
                                      ...
                                      <input type="number" class="form-control" id="inputorder" required name="ref_from_age" value="<?php echo $data['ref_from_age']; ?>">
								    </div>
								  </div>
								    ...
								    <div class="col-sm-10">
								      <!--<input type="date" class="form-control"  data-date="today"  value="<?php //echo date('Y-m-d'); ?>"  id="inputorder" name="order" > !-->
                                      <input type="number" class="form-control" id="inputorder"  name="ref_to_age" value="<?php echo $data['ref_to_age']; ?>">
								    </div>
								  </div>
                                  ...
                                  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								     <select class="form-control" id="select-1" name="ref_gender">
                                            <option value="male" <?php if( $data['ref_gender']=='male') echo 'selected'; ?> >Male</option>
                                            <option value="female" <?php if( $data['ref_gender']=='female') echo 'selected'; ?> >Female</option>
                                      </select>
								    </div>
								  </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="inputorder" name="order" value="<?php echo $data['order']; ?>">
								    </div>
								  </div>
