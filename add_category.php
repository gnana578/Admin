...
if (isset($_POST['submit']))
 {
	 ...
	 $order=trim($_POST['order']);
	  ...
	  $query="INSERT INTO category (`category`, `order`) VALUES ('$category', '$order');";
	  					...
	  					<div class="content-box-large">
			  				...
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" id="inputcategory" name="category" required placeholder="Category">
								    </div>
								  </div>
