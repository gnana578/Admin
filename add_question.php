...
if (isset($_POST['submit']))
 {
	 ...
	 $order=trim($_POST['order']);
	  ...
	  $query="INSERT INTO `question` ( `question`, `asign_score`, `order`,`categoryid`) VALUES('$question',$ref_score, $order,'$category');";
	  mysqli_query($con,$query) or die(mysqli_error($con));
	  echo"<script>alert('Question save successfully');</script>";
	  					...
	  					<div class="content-box-large">
			  				...
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <textarea id="tinymce_basic" name="question"></textarea>
								    </div>
								  </div>
                                  <div class="form-group">
								    <label for="inputorder" class="col-sm-2 control-label">Asign Score</label>
								    <div class="col-sm-10">
								      <input type="number" class="form-control" id="inputorder" required name="ref_score" placeholder="+1 OR -1" value="">
								    </div>
								  </div> 
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" id="inputorder" name="order" required value="">
								    </div>
								  </div>
